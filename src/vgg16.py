...
class VGG(nn.Module):
    def __init__(self, vgg_name, activation, initializer, sample_input = None):
...
def vgg16(activation, initializer, sample_input = None):
    return VGG('VGG16', activation, initializer, sample_input)